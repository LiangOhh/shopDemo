<template>
    <div class="cart">
        <a class="curr" href="javascript:;">
            <i class="iconfont icon-gouwuche" @click="$router.push('/cart')"></i><em>{{ cartList.length }}</em>
        </a>
        <div class="layer">
            <div class="list">
                <div class="item" v-for="item in cartList" :key="item.id">
                    ...
                    <i class="iconfont icon-shanchu3" @click="delCart(item.skuId)"></i>
                </div>
